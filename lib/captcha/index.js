...
export default {
  ...
  components: (_components = {}, _defineProperty(_components, Dialog.name, Dialog), _defineProperty(_components, Codebox.name, Codebox), _defineProperty(_components, Button.name, Button), _components),
