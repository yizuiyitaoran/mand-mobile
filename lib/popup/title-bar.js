...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './mixins/title-bar', '../_style/global.css', './style/title-bar.css'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./mixins/title-bar'), require('../_style/global.css'), require('./style/title-bar.css'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.titleBar, global.global, global.titleBar);
