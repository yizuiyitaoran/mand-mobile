...
export default {
  ...
  components: (_components = {}, _defineProperty(_components, Icon.name, Icon), _defineProperty(_components, FieldItem.name, FieldItem), _defineProperty(_components, NumberKeyboard.name, NumberKeyboard), _components),
  ...
  methods: {
    ...
    $_onInput: function $_onInput(event) {
      var formateValue = this.$_formateValue(event.target.value, this.isInputFormative ? getCursorsPosition(event.target) : 0);
