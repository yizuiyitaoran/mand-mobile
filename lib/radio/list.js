...
export default {
  ...
  components: (_components = {}, _defineProperty(_components, Radio.name, Radio), _defineProperty(_components, Field.name, Field), _defineProperty(_components, CellItem.name, CellItem), _defineProperty(_components, InputItem.name, InputItem), _components),
