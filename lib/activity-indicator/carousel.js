...
export default {
  ...
  components: _defineProperty({}, CarouselCircle.name, CarouselCircle),
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"md-activity-indicator-carousel"},[_c('svg',{staticClass:"md-activity-indicator-svg carouseling",style:({width: (_vm.viewWidth + "px"), height: (_vm.size + "px")}),attrs:{"xmlns":"http://www.w3.org/2000/svg","viewBox":_vm.viewBox,"fill":_vm.color}},_vm._l((_vm.circleAnimateValues),function(value,index){return _c('md-activity-indicator-carousel-circle',{key:("carousel-circle-" + index),attrs:{"size":_vm.size,"index":index,"animate-values":value}})}),1)])}
