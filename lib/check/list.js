...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './index', './group', '../cell-item', '../_style/global.css', './style/list.css'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./index'), require('./group'), require('../cell-item'), require('../_style/global.css'), require('./style/list.css'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.index, global.group, global.cellItem, global.global, global.list);
    global.list = mod.exports;
  }
})(this, function (exports, _index, _group, _cellItem) {
  'use strict';
