...
var TYPE_FORMAT_INVERSE = toObject(Object.keys(TYPE_FORMAT).map(function (item) {
...
export default {
  ...
  components: _defineProperty({}, Picker.name, Picker),
  ...
  methods: {
    ...
    $_generateMonthData: function $_generateMonthData() {
      var args = this.$_getGeneratorArguments(toArray(arguments));
      var start = void 0,
          end = void 0;
    ...
    $_generateData: function $_generateData(from, to, type, unit) {
      ...
      var text = void 0;
      var data = [];
      var defaultArgs = toArray(args).map(function (item) {
