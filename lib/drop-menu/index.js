...
export default {
  ...
  components: (_components = {}, _defineProperty(_components, Popup.name, Popup), _defineProperty(_components, RadioList.name, RadioList), _components),
  ...
  methods: {
    $_initSelectedBar: function $_initSelectedBar() {
      ...
      traverse(this.data, ['options'], function (item, level, indexs) {
